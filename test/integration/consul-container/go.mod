module github.com/myback/oca/test/integration/consul-container
...
require (
	...
	github.com/myback/oca/api v1.24.0
	github.com/myback/oca/envoyextensions v0.4.1
...
replace (
	...
	github.com/myback/oca/testing/deployer => ../../../testing/deployer
)
